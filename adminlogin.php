                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="content">
                                    <form action="adminlogin.php" method="POST" id="loginForm" name="loginForm">
                                        <div>
                                            <?php echo $result;?>
                                        </div> 
                                            <div>    
                                            ...
                                            <div class="col-lg-8">
                                                <div>
                                                   <button  type="submit" class="btn btn-danger btn-fill"  name="login">LOgin </button>
                                                
                                                    <a href="adminsignup.php" class="btn btn-danger "  >Sign up</a>
                                                </div>
                                            </div>
                                    </form> 
                                </div>
